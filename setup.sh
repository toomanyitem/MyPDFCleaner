...
echo "🔧 กำลังเตรียมโปรเจกต์ MyPDFCleaner..."
...
# 4) สร้าง remove_text.py ใหม่ (ตามเวอร์ชันเลือกไฟล์ PDF ได้)
...
echo "✨ ติดตั้งสำเร็จ พร้อมใช้งานแล้ว!"
echo "🔹 เริ่มงานด้วยคำสั่ง:"
echo "    source venv/bin/activate"
echo "    python remove_text.py"
echo "----------------------------------------"
